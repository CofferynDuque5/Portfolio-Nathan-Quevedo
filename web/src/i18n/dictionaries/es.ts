...
export const es = {
  ...
  whatsapp: {
    ...
    post: (title: string) => `Hola, leí el artículo "${title}" y tengo una consulta.`,
  },
  hero: {
  ...
  blog: {
    ...
    otherPosts: 'Más artículos',
    prev: 'Anterior',
    next: 'Siguiente',
    ctaTitle: '¿Quieres que te ayude con esto?',
    rss: 'Suscribirse por RSS',
    emptyTitle: 'Muy pronto, nuevos artículos',
    emptyText: 'Estoy preparando guías y consejos prácticos. Mientras tanto, cuéntame qué necesitas.',
    emptyTag: 'Todavía no hay artículos con esta etiqueta.',
    emptyCta: 'Escribirme',
  },
  cta: {
  ...
  pages: {
    ...
    blog: {
      metaTitle: 'Blog: guías y consejos de tecnología',
      metaDescription:
        'Guías prácticas de Nathan Quevedo sobre streaming, licencias de software, seguridad y soporte técnico.',
      eyebrow: 'Blog',
      title: 'Guías, consejos y novedades',
      lead: 'Explicaciones claras para sacar el máximo partido a tus plataformas, licencias y equipos.',
