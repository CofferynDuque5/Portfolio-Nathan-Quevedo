...
export const fallbackContent: SiteContent = {
  ...
  services: [
    ...
    { id: 6, title: 'Almacenamiento en la Nube', slug: 'nube', icon: 'Cloud', shortDesc: 'Google One, OneDrive, Dropbox.', image: '/services/nube.svg', featured: false, order: 5, active: true },
  ],
  platforms: [],
  licenses: [],
  faqs: [
